 ...
 *
 * @fn OF_INT32	of_popcount_3		(OF_UINT64 x)
 ...
 *
 * @fn OF_UINT32	of_hweight32		(OF_UINT32 w)
 ...
 *
 * @fn OF_UINT32	of_hweight32_naive		(OF_UINT32 w)
 * @brief		return the hamming weight of a 32bits word
 * @param w		(IN) 32bits word
 * @return		hamming weight of w
 */
 ...
 *
 * @fn OF_UINT32	of_hweight32_table		(OF_UINT32 w)
 * @brief		return the hamming weight of a 32bits word
 * @param w		(IN) 32bits word
 * @return		hamming weight of w
 */
 ...
 *
 * @fn OF_UINT32	of_hweight_array		(OF_UINT32 *array, OF_INT32 size)
 * @brief		return the hamming weight of a 32bits word
