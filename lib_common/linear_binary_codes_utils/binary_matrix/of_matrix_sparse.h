...
{
	OF_INT32 n_rows;		  /* Number of rows in the matrix */
	OF_INT32 n_cols;		  /* Number of columns in the matrix */
...
#ifdef LDPC_QC
	OF_INT32 exp_factor;           /* expansion factor of the matrix, it is also the size of the circulant matrix */
#endif
} of_mod2sparse;
...
#else
of_mod2entry * of_mod2sparse_last_in_col (of_mod2sparse * m, OF_UINT32 i); /* a bit more complex if we don't have the "up" pointer */
#endif
...
of_mod2sparse *of_mod2sparse_allocate (OF_UINT32, OF_UINT32);
...
void of_mod2sparse_copyrows (of_mod2sparse *, of_mod2sparse *, OF_UINT32 *);
void of_mod2sparse_copycols (of_mod2sparse *, of_mod2sparse *, OF_UINT32 *);
...
#if 0
OF_UINT32  mod2sparse_write (FILE *, of_mod2sparse *);
of_mod2sparse *mod2sparse_read (FILE *);
#endif // #if 0

OF_UINT32 of_mod2sparse_write_human_readable (FILE *,
					   of_mod2sparse *,
					   OF_UINT32 nb_source,
					   OF_UINT32 nb_parity);
 ...
 */
OF_UINT32  of_mod2sparse_swap_rows (of_mod2sparse * m,
				 OF_UINT32 row0,
				 OF_UINT32 row1,
 ...
 */
OF_UINT32  of_mod2sparse_xor_rows (of_mod2sparse * m,
				OF_UINT32 row0, OF_UINT32 row1,
				of_mod2entry ** __links,
				of_mod2entry ** __parsing);
...
void mod2sparse_mulvec (of_mod2sparse *, OF_UINT8 *, OF_UINT8 *);

OF_UINT32 mod2sparse_equal (of_mod2sparse *, of_mod2sparse *);

OF_UINT32 mod2sparse_count_row (of_mod2sparse *, OF_UINT32);
OF_UINT32 mod2sparse_count_col (of_mod2sparse *, OF_UINT32);

void mod2sparse_add_row (of_mod2sparse *, OF_UINT32, of_mod2sparse *, OF_UINT32);
void mod2sparse_add_col (of_mod2sparse *, OF_UINT32, of_mod2sparse *, OF_UINT32);

OF_UINT32 mod2sparse_decomp (of_mod2sparse *, OF_UINT32, of_mod2sparse *, of_mod2sparse *,
		       OF_UINT32 *, OF_UINT32 *, mod2sparse_strategy,OF_UINT32, OF_UINT32);

OF_UINT32 mod2sparse_forward_sub (of_mod2sparse *, OF_UINT32 *, OF_UINT8 *, OF_UINT8 *);
OF_UINT32 mod2sparse_backward_sub (of_mod2sparse *, OF_UINT32 *, OF_UINT8 *, OF_UINT8 *);
#endif
