...
typedef OF_UINT32 of_mod2word;	/* Data type that holds packed bits */
...
typedef struct
{
	OF_UINT32 n_rows;		/* Number of rows in the matrix */
	OF_UINT32 n_cols;		/* Number of columns in the matrix */

	OF_UINT32 n_words;		/* Number of words used to store a column of bits */
...
of_mod2dense *of_mod2dense_allocate (OF_UINT32, OF_UINT32);
void of_mod2dense_free (of_mod2dense *);

void of_mod2dense_clear (of_mod2dense *);
void of_mod2dense_copy (of_mod2dense *, of_mod2dense *);
void of_mod2dense_copyrows (of_mod2dense*, of_mod2dense *, OF_UINT32 *);
void of_mod2dense_copycols (of_mod2dense*, of_mod2dense *, OF_UINT32 *);

void of_mod2dense_print (FILE *, of_mod2dense *);
OF_UINT32  of_mod2dense_write (FILE *, of_mod2dense *);
of_mod2dense *of_mod2dense_read (FILE *);

OF_UINT32  of_mod2dense_get (of_mod2dense *, OF_UINT32, OF_UINT32);
OF_INT32   of_mod2dense_set (of_mod2dense *, OF_UINT32, OF_UINT32, OF_UINT32);
OF_UINT32  of_mod2dense_flip (of_mod2dense *, OF_UINT32, OF_UINT32);
...
OF_UINT32 of_mod2dense_equal (of_mod2dense *, of_mod2dense *);

OF_UINT32 of_mod2dense_invert (of_mod2dense *, of_mod2dense *);
OF_UINT32 of_mod2dense_forcibly_invert (of_mod2dense *, of_mod2dense *, OF_UINT32 *, OF_UINT32 *);
OF_UINT32 of_mod2dense_invert_selected (of_mod2dense *, of_mod2dense *, OF_UINT32 *, OF_UINT32 *);

OF_UINT32 of_mod2dense_triangularize (of_mod2dense *, of_mod2dense *);
...
bool of_mod2dense_row_is_empty (of_mod2dense *m, OF_UINT32	row); // VR added
OF_UINT32 of_mod2word_weight (of_mod2word); // MC added

OF_UINT32 of_mod2dense_row_weight (of_mod2dense *, OF_UINT32); // MC added
OF_UINT32 of_mod2dense_row_weight_ignore_first (of_mod2dense *m, OF_UINT32 i, OF_UINT32 nb_ignore);// MC added
OF_UINT32 of_mod2dense_col_weight (of_mod2dense *, OF_UINT32); // MC added

void of_mod2dense_print_stats (FILE *, of_mod2dense *);// MC added

//void of_mod2dense_add_row (of_mod2dense *, OF_UINT32 , OF_UINT32); // MC added
//void of_mod2dense_add_row_ignore_first (of_mod2dense *, OF_UINT32 , OF_UINT32, OF_UINT32); // MC added
