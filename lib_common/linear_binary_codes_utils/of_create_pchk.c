...
of_mod2sparse* of_create_pchk_matrix (OF_UINT32		nb_rows,
				      OF_UINT32		nb_cols,
...
of_mod2sparse* of_create_pchk_matrix_general (OF_UINT32		nb_rows,
					      OF_UINT32		nb_cols,
					      make_method	make_method,
					      OF_UINT32		left_degree,
					      OF_UINT32		seed,
					      ...
					      OF_UINT8		verbosity)
{
	OF_UINT32 row_start = 0;
	OF_UINT32 row_end = 0;
	OF_UINT32 col_start = 0;
	OF_UINT32 col_end = 0;
	OF_INT32 i;
...
of_mod2sparse* of_create_2D_pchk_matrix		(OF_UINT32		nb_rows,
						OF_UINT32		nb_cols,
						of_session_type	type,
						OF_UINT8		verbosity)
{
					    ...
					    OF_UINT8		verbosity)
{
	...
	case Evenboth:
		u = (OF_UINT32*) of_calloc (left_degree * nb_col, sizeof * u);
