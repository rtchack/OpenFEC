...
//
//    David G. Carta
//    Two Fast Implementations of the "Minimal Standard" Random Number GeneratorUnit
 ...
 * (2^^31-2) inclusive.
 */
void of_rfc5170_srand (OF_UINT64 s)
{
	OF_ENTER_FUNCTION
	if ( (s >= 1) && (s <= 0x7FFFFFFE))
		of_seed = s;
 ...
 */
OF_UINT64
of_rfc5170_rand (OF_UINT64	maxv)
{
	//OF_ENTER_FUNCTION
	OF_UINT64	hi, lo;
